...
הפרויקט מחולק לשתי תתי-מערכות עיקריות בתוך התיקייה הראשית (`KC/DEV`):
...
## 🌍 הערה חשובה: סביבות עבודה
אנחנו עובדים עם שתי סביבות נפרדות.
1.  **Development (פיתוח):** הסביבה המקומית אצלך במחשב. כאן מותר לשבור דברים. האפליקציה תציג **באנר ירוק למעלה**.
2.  **Production (האמיתי):** זה מה שהלקוחות רואים. כאן אסור לגעת סתם. **אין באנר** בסביבה הזאת.

**חוק ברזל:** אם אתה רואה באנר ירוק - אתה בטוח. הכל בסדר.
